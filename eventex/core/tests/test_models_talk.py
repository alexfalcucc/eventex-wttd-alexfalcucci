...
class CourseModelTest(TestCase):
		def setUp(self):
			self.course = Course.objects.create(title=u'Tutorial Django',
												description=u'Descrição do curso', start_time='10:00', 
												slots=20)
		def test_create(self):
		...
		def test_speakers(self):
			...
			self.course.speakers.create(name='Alexsander Falcucci',
									   slug='alexsander-falcucci', url='http://alexsanderfalcucci.com')
